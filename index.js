...
// Functions
(0, utilis_1.showReviewTotal)(reviews.length, reviews[0].name, reviews[0].loyaltyUser);
(0, utilis_1.populateUser)(you.isReturning, you.firstName);
// Add properties
for (var i = 0; i < properties.length; i++) {
    ...
    (0, utilis_1.showDetails)(you.permissions, card, properties[i].price);
...
function addReviews(array) {
    if (!count) {
        count++;
        var topTwo = (0, utilis_1.getTopTwoReviews)(array);
...
var currentLocation = ['Nairobi', '16:30', 19];
footer.innerHTML =
    currentLocation[0] +
        ' ' +
        currentLocation[1] +
